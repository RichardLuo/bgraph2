...
from bgraph.backup import (get_aosp_root, test_subdirs, backup_module, gen_backup_path, restore_module,
                           is_normal_module_path, is_backup_module_path, conv_to_normal_path, write_line_to,
                           get_valid_folder, conv_to_backup_path, restore_from_backup_root, validate_module_path)
        ...
        with subprocess.Popen(command,
            ...
            if success is True:
                ...
                if module_path and fixed_modules_file:
                    ...
                    write_line_to(fixed_modules_file, 'a', str(module_path))
            ...
            for path in paths:
                if not path.exists():
                    ...
                    if success:
                        ...
                        write_line_to(success_modules_file, 'a+', path)
                    else:
                        logger.info("FAILED PATH:%s", path)
                        write_line_to(failed_modules_file, 'a+', path)
