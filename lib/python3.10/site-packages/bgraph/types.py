...
all_module_types = [
"generate_mojom_downgraded_files", "libart_static_cc_defaults", "cc_benchmark_host", "prebuilt_apis", "art_apex_test", "robolectric_build_props", "hiddenapi_flags", "rust_test", "ndk_prebuilt_shared_stl", "javadoc", "aidl_mapping", "generate_mojom_srcjar", "dex_import", "generate_mojom_pickles", "rust_binary_host", "display_go_defaults_sm7250", "hidl_interfaces_metadata", "aidl_interfaces_metadata", "force_build_llvm_components_defaults", "rust_defaults", "art_apex_test_host", "clang_builtin_headers", "llndk_headers", "generate_mojom_srcs", "llvm_host_defaults", "target_fs_config_gen_filegroup", "art_debug_defaults", "versioned_ndk_headers", "sh_test_host", "llvm_defaults", "sanitizer_status_library_shared", "generate_mojom_headers", "display_go_defaults", "llvm_prebuilt_library_static", "global_compat_config", "doc_defaults", "kernel_headers", "libart_cc_defaults", "sdk", "java_host_for_device", "droidstubs_host", "rust_prebuilt_dylib", "art_apex", "art_global_defaults", "soong_config_module_type", "bootstrap_go_binary", "ca_certificates", "droiddoc_host", "override_apex", "tradefed_java_library_host", "ca_certificates_host", "llvm_host_prebuilt_library_shared", "android_app_import", "ndk_prebuilt_static_stl", "llvm_darwin_filegroup", "module_exports", "rust_library_dylib", "java_genrule_host", "service_contexts", "toolchain_library", "libclang_rt_llndk_library", "fluoride_defaults", "wayland_protocol_codegen", "art_cc_library_static", "property_contexts", "prebuilt_usr_share", "hwservice_contexts", "file_contexts", "python_test", "vintf_compatibility_matrix", "bpf", "rust_proc_macro", "platform_compat_config", "tradefed_binary_host", "droiddoc_exported_dir", "sysprop_library", "java_system_modules", "java_device_for_host", "clang_tblgen", "stubs_defaults", "java_sdk_library_import", "android_test_import", "prebuilt_etc_host", "llvm_tblgen", "genrule_defaults", "art_cc_test_library", "cc_library_host_shared", "hidl_package_root", "se_filegroup", "apex_test", "rust_test_host", "droiddoc", "java_test_helper_library", "kernel_config", "sh_binary_host", "se_cil_compat_map", "art_cc_defaults", "java_binary", "apex_defaults", "gensrcs", "cc_object", "llndk_library", "libclang_rt_prebuilt_library_shared", "rust_library_rlib", "java_plugin", "ndk_library", "android_robolectric_test", "java_sdk_library", "art_cc_test", "xsd_config", "cc_prebuilt_library_shared", "cc_genrule", "python_defaults", "droidstubs", "sh_binary", "blueprint_go_binary", "ndk_headers", "java_genrule", "python_library", "phony", "cc_prebuilt_binary", "art_cc_binary", "java_test", "prebuilt_apex", "libclang_rt_prebuilt_library_static", "apex_key", "python_test_host", "rust_library_host_rlib", "runtime_resource_overlay", "cc_benchmark", "android_app_certificate", "python_library_host", "java_binary_host", "prebuilt_usr_share_host", "aidl_interface", "cc_library_host_static", "cc_test_host", "cc_fuzz", "ndk_prebuilt_object", "apex", "art_cc_library", "java_defaults", "python_binary_host", "bootstrap_go_package", "java_import_host", "java_import", "android_library_import", "java_library_static", "cc_binary_host", "java_library_host", "prebuilt_etc", "hidl_interface", "cc_library_headers", "android_library", "prebuilt_font", "android_app", "java_test_host", "java_library", "cc_test_library", "cc_library", "vts_config", "genrule", "cc_library_shared", "cc_binary", "android_test", "cc_defaults", "sh_test", "filegroup", "android_test_helper_app", "cc_library_static", "vndk_prebuilt_shared", "cc_test",  ]
