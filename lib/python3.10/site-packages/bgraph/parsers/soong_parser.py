...
import bgraph.exc
import bgraph.utils
from bgraph.types import (Any, Dict, Final, List, Literal, Optional, Section, SectionNode,
...
class SoongParser:
    ...
    def parse_project(
        ...
        for soong_file in project_directory.rglob(file_name):
            # logger.info(">> parse file:%s directory:%s", soong_file, project_directory)
        ...
        # raise LookupError
        # for soong_file in project_directory.rglob("Android.sources.bp"):
        #     # logger.info(">> parse file:%s directory:%s", soong_file, project_directory)
        #     self.parse_file(
        #         file_path=soong_file,
        #         project_name=project_name,
        ...
        # for soong_file in project_directory.rglob("sources.bp"):
        #     # logger.info(">> parse file:%s directory:%s", soong_file, project_directory)
        #     self.parse_file(
        #         file_path=soong_file,
        #         project_name=project_name,
        ...
        # for soong_file in project_directory.rglob("AndroidGen.bp"):
        #     # logger.info(">> parse file:%s directory:%s", soong_file, project_directory)
        #     self.parse_file(
        #         file_path=soong_file,
        #         project_name=project_name,
        ...
        #     logger.info("--> parse generic file %s", soong_file)
...
class SoongFileParser:
    ...
    def __init__(
        ...
        if file_path:
            ...
            if self.identifiers:
                print("identifiers:", list(self.identifiers))
